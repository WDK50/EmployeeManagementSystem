...
class Employee(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, default=timezone.now)   # set once when created
    updated_at = models.DateTimeField(auto_now=True,default=timezone.now)       # updates on every save
