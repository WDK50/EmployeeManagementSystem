...
from employee.views import create_employee,delete_employee, individual_employee, search_employee, send_email,update_employee,employee_list # type: ignore
...
urlpatterns = [
  ...
  path('delete/<int:pk>/', delete_employee, name='delete'), 
   path("bulk-delete/", views.bulk_delete_employee, name="bulk_delete"),
